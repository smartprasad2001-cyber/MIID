#!/usr/bin/env python3
"""
Detailed test of Cambodia business/POI addresses - check each address individually and batch validation
"""
...
def main():
    """Test all Cambodia business addresses individually and as a batch"""
    cambodia_addresses = [
        "SO CHOU - French Pastry & Choux, Krong Siem Reap, 171202, Cambodia",
        "Yoga Space, Siem Reap, 171202, Cambodia",
        "Cam Cane Juice, Kampong Cham, 3000, Cambodia",
        "Brown Coffee, Toul Tom Poung, Phnom Penh, 12301, Cambodia",
        "Thai Huot Market, Siem Reap, 171205, Cambodia",
        "Dee Coffee, Siem Reap, 171205, Cambodia",
        "Amazon Café, Battambang, 020801, Cambodia",
        "Sisters II Café, Battambang, 020801, Cambodia",
        "Blue Pumpkin, Siem Reap, 171205, Cambodia",
        "Le Malraux, Siem Reap, 171202, Cambodia",
        "Brother Bong Cafe, Phnom Penh, 120202, Cambodia",
        "Khema Restaurant, Phnom Penh, 12207, Cambodia",
        "Niko's Café, Phnom Penh, 12211, Cambodia",
        "Roma Italian Restaurant, Siem Reap, 171204, Cambodia",
        "Crane Café, Phnom Penh, 12211, Cambodia"
    ]
    
    print("="*80)
    print("DETAILED VALIDATION OF CAMBODIA BUSINESS/POI ADDRESSES")
    print("="*80)
    ...
    # Save results
    output_file = "cambodia_businesses_validation_results.json"
