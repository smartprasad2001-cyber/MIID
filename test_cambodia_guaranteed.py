#!/usr/bin/env python3
"""
Detailed test of Cambodia guaranteed 1.0 addresses - check each address individually and batch validation
"""
...
def main():
    """Test all Cambodia guaranteed addresses individually and as a batch"""
    cambodia_addresses = [
        ...
        "17 Wat Bo Road, Sala Kamraeuk, Siem Reap, 171201, Cambodia",
        "19 Wat Bo Road, Sala Kamraeuk, Siem Reap, 171201, Cambodia",
        "33 Taphul Road, Taphul Village, Siem Reap, 171204, Cambodia",
        "35 Taphul Road, Taphul Village, Siem Reap, 171204, Cambodia",
        "8 Street 27, Svay Dangkum, Siem Reap, 171202, Cambodia",
        "10 Street 27, Svay Dangkum, Siem Reap, 171202, Cambodia",
        "22 Sala Lodge Road, Sala Kamraeuk, Siem Reap, 171201, Cambodia",
        "24 Sala Lodge Road, Sala Kamraeuk, Siem Reap, 171201, Cambodia",
        "32 Sala Lodge Road, Sala Kamraeuk, Siem Reap, 171201, Cambodia"
    ]
    
    print("="*80)
    print("DETAILED VALIDATION OF CAMBODIA GUARANTEED 1.0 ADDRESSES")
    print("="*80)
    ...
    # Save results
    output_file = "cambodia_guaranteed_validation_results.json"
