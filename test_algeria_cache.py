#!/usr/bin/env python3
"""
Test Algeria addresses from validated_address_cache_priority.json
                ...
                if api_attempts:
                    ...
                    for attempt in api_attempts:
                        ...
                        if isinstance(result, dict):
                            ...
                            area = result.get('min_area', 'N/A')
                            print(f"     - {addr}... → Score: {score} (area: {area} m²)")
                        else:
                            print(f"     - {addr}... → {result}")
