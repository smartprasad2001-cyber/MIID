#!/usr/bin/env python3
"""
Detailed test of Argentina addresses - check each address individually and batch validation
"""
...
def main():
    """Test all Argentina addresses individually and as a batch"""
    argentina_addresses = [
        "901, Avenida del Libertador, Vicente López, 1638, Argentina",
        "1200, Avenida Bartolomé Mitre, Avellaneda, 1870, Argentina",
        "446, San Jerónimo, Córdoba, 5000, Argentina",
        "502, Boulevard Chacabuco, Córdoba, 5000, Argentina",
        "79, San Lorenzo, Córdoba, 5000, Argentina",
        "Avenida Monseñor Pablo Cabrera, 5008, Argentina",
        "202, Diagonal 74, La Plata, 1900, Argentina",
        "2475, Calle 525, La Plata, 1900, Argentina",
        "1450, Calle 140, La Plata, 1900, Argentina",
        "1501, Calle 140, La Plata, 1900, Argentina",
        "1002, Diagonal 74, La Plata, 1900, Argentina",
        "1899, Calle 523, La Plata, 1900, Argentina",
        "1801, Calle 524 Bis, La Plata, 1900, Argentina",
        "1899, Calle 524 Bis, La Plata, 1900, Argentina",
        "1801, Calle 524, La Plata, 1900, Argentina"
    ]
    ...
    # Save results
    output_file = "argentina_new_detailed_validation_results.json"
